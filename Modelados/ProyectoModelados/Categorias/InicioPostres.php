...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
      <a class="nav-link text-dark" href="./InicioLight.php" >Light</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark" href="./InicioCaseras.php">Caseras</a>
      </li>
      <li class="nav-item">
        <a class="nav-link disable" href="#"  aria-disabled="true">Postres</a>
      </li>
    </ul>
...
<div class="container fondo">
  ...
  <img src="./ImgAli/" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Postre</h5>

    <a href="../Combinaciones/Hotdog.php " class="btn btn-primary">Ver receta</a>
  </div>    
    </div>
    </div>
    <div class="col-sm">
